...
import project1pic from "../../assets/Screenshot 2025-03-09 000512.png";
import project2pic from '../../assets/shifra_bot.png'
import project3pic from "../../assets/Whether.png";
...
function Navbar() {
  ...
  return (
    <>
      ...
      <nav
        id="home"
        className=" w-100 navbar navbar-expand-lg bg-body-tertiary "
        style={{ padding: "0%", marginBottom: "2%" }}
      >
        <div
          className="container-fluid h-6 p-2 fixed-top mb-3"
          ...
          <div className="col-md-6 about2ndtxt">
            ...
            >
              <p className="about-mng">
                ...
                HTML,CSS,JavaScript,React and Bootstrap, and I am exicited for
                put my skills to use in a professional. I like travelling and
                learning new things, and I am confident that I can be a valuable
      ...
      <div id="skills" className="container-fluid ">
        <div className=" row my-5 justify-content-center d-flex ">
          <h2 className=" w-50 justify-content-center d-flex">Skills</h2>
        </div>
        <div className="row">
          <div className="col-md-12 justify-content-center d-flex ">
            <ul
              className="skills_section list-unstyled w-75 "
              data-aos="slide-right"
              data-aos-duration="2000"
              style={{
                borderRadius: "15px",
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div
              ...
              data-aos="slide-right"
              data-aos-duration="2000"
              style={{ border: `2px solid ${color}`, borderRadius: "14px" }}
            >
              <img
                class="card-img-top pb-4"
                style={{ borderRadius: "12px", border: `1px solid ${color}` }}
                src={project1pic}
                alt="Card image cap"
              />
              <div class="card-body">
                ...
                <p class="card-text text-xl-start" style={{ fontSize: "20px" }}>
                  {" "}
                  Tasty Burger is a sleek and modern food ordering website that
                  offers a seamless shopping cart experience with local storage
                  integration. Featuring a user-friendly design, it allows
                  customers to browse delicious burgers, add items to their
                  cart, and manage orders effortlessly{" "}
                </p>
                <div className="d-flex flex-column">
                  ...
                  <p
                    class="card-text text-xl-start pb-4"
                    style={{ fontSize: "20px" }}
                  >
                    {" "}
                ...
                <div className="">
                  <Link to="https://github.com/BROALOK/Tasty-Burger">
                    <button
                      href="#"
                      class="btn mx-2 text-light mb-4"
           ...
           <div className="col-md-6">
            ...
            >
              ...
              <div class="card-body">
                ...
                <p class="card-text text-xl-start" style={{ fontSize: "20px" }}>
                  {" "}
                  Developed Shifra, a voice AI assistant leveraging Google Gemini API with integrated speech recognition and synthesis, enabling real-time natural language interactions and optimized for performance through scalable API architecture to enhance user engagement.{" "}
                </p>
                <div className="d-flex flex-column">
                  <p
                    class="card-text text-xl-start"
                ...
                <div className="">
                  <Link to="https://github.com/BROALOK/Shifra-AI">
                    <button
                      href="#"
                      class="btn mx-2 text-light mb-4"
                      style={{ backgroundColor: color, fontWeight: "600" }}
                  ...
                  <Link to="https://shifra-ai-six.vercel.app/">
                    <button
                      href="#"
                      class="btn mx-2 text-light mb-4"
                      style={{ backgroundColor: color, fontWeight: "600" }}
          ...
          <div className="col-md-6">
            ...
            >
              ...
              <div class="card-body">
                ...
                <p class="card-text text-xl-start" style={{ fontSize: "20px" }}>
                  {" "}
                  Built a dynamic weather application that utilizes geolocation to display real-time temperature data for the user’s current location, with additional functionality to search weather conditions in other cities; designed with a clean, intuitive UI for smooth navigation and responsive user experience.{" "}
                </p>
                <div className="d-flex flex-column">
                  <p
                    class="card-text text-xl-start"
                ...
                <div className="">
                  <Link to="https://github.com/BROALOK/Weather-app">
                    <button
                      href="#"
                      class="btn mx-2 text-light mb-4"
                      style={{ backgroundColor: color, fontWeight: "600" }}
                  ...
                  <Link to="https://weather-app-chi-seven-65.vercel.app/">
                    <button
                      href="#"
                      class="btn mx-2 text-light mb-4"
                      style={{ backgroundColor: color, fontWeight: "600" }}
        ...
        >
          <div className="col-md-12 d-flex justify-content-center flex-column align-items-center">
            <Link
              ...
              to="https://github.com/BROALOK"
              data-aos="slide-right"
              data-aos-duration="2000"
              style={{ textDecoration: "none" }}
            >
              <button
                className="w-50 py-1 my-3 btn_hov "
                style={styling}
      ...
      onMouseLeave={() => setIsHoverd1(false)} >              LinkedIn
            ...
            <button
              className="w-50 py-1 my-3 btn_hov "
              style={styling3}
              onMouseEnter={() => setIsHoverd3(true)}
              onMouseLeave={() => setIsHoverd3(false)}
            >
              {" "}
              alok45990@gmail.com
            </button>
